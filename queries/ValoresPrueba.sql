...
INSERT INTO profesores (
  ...
  ('87654321', 'Maria Gomez', 'Av. 2', '04240000000', 'I', 'MT', '2001-01-01', NULL, 'R'),
  ...
  ('10000007', 'Ana Rodriguez', 'Av. 7', '04240000002', 'I', 'MT', '2002-07-27', NULL, 'R'),
  ...
  ('10000013', 'Jorge Gomez', 'Av. 13', '04160000004', 'I', 'TV', '2002-01-01', NULL, 'P'),
  ('10000014', 'Luis Perez', 'Av. 14', '04140000005', 'I', 'MT', '2000-01-01', NULL, 'J'),
  ...
  ('10000017', 'Leonardo Garcia', 'Av. 15', '04240000016', 'T', 'MT', '2002-01-01', '2012-01-01', 'R'),
  ('10000018', 'Franklin Gonzales', 'Av. 15', '04240000018', 'T', 'MT', '2002-01-01', '2012-01-01', 'R');
...
-- valores de prueba para la 7
  ('009', 'ASG101', '201215', '10000009'),
  ('010', 'ASG102', '201225', '10000010'),
  ('011', 'ASG103', '201315', '10000009'),
  ('012', 'ASG104', '201325', '10000009'),
  ('013', 'ASG105', '201415', '10000010'),
  ('014', 'ASG106', '201425', '10000009'),
  ('015', 'ASG107', '201515', '10000009'),
  ('016', 'ASG108', '201615', '10000010'),
  ('017', 'ASG109', '201625', '10000009'),
  ('019', 'ASG104', '201715', '10000009'),
  ('020', 'ASG103', '201725', '10000010'),
  ('021', 'ASG102', '201815', '10000009'),
-- valores de prueba para la 8
  ('022', 'ASG104', '202325', '10000009'),
  ('023', 'ASG103', '202325', '10000010'),

  ('024', 'ASG103', '201015', '10000016'),
  ('025', 'ASG105', '201025', '10000017'),
  ('026', 'ASG102', '201115', '10000018');
